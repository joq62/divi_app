...
%% --------------------------------------------------------------------
start()->
    ok=application:start(divi_app),
    pong=mydivi:ping(),

    5.0=mydivi:divi(25,5),
    {error,[badarith_try_to_divide_zero]}=mydivi:divi(25,0),
...
load_test()->
    AppId="sd_lib",
    Vsn="0.1.0",
    GitPath="https://github.com/joq62/sd_lib.git",
